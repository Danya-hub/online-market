        ...
        <form action="{{ route("cart.add", $product) }}" method="POST">
            ...
            <div class="flex mt-3">
                @foreach($options as $option => $values)
                    <label class="me-6">
                        ...
                        <select name="options[]" class="bg-gray-300 px-3 py-2 rounded mt-2">
            ...
            <div class="flex mt-5">
                <x-form.counter
                    ...
                    action=""
                ></x-form.counter>
                <button type="submit" class="block bg-green-400 rounded px-3 py-2 me-2 font-medium">Добавить в корзину
                </button>
