...
class DomainCommand extends Command
{
    ...
    protected $signature = 'market:domain';
    ...
    public function registerRouteRegistrar(): void
    {
    ...
    public function registerMethodSignature(): string
    {
        return 'public function register(): void'.PHP_EOL.'    {'.PHP_EOL;
    }

    public function appRegister(string $prefix): string
    {
    ...
    public function makeDomainServiceProvider(string $name, string $stub): void
    {
        file_put_contents(
